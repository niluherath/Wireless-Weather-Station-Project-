...
//  	array('', $ReadingHour2.'.55', $Slot12Average2),
	...
	// current hour
	array('', $ReadingHour.'.00', $Slot1Average*1.6),
	array('', $ReadingHour.'.05', $Slot2Average*1.6),
  	array('', $ReadingHour.'.10', $Slot3Average*1.6),
  	array('', $ReadingHour.'.15', $Slot4Average*1.6),
  	array('', $ReadingHour.'.20', $Slot5Average*1.6),
  	array('', $ReadingHour.'.25', $Slot6Average*1.6),
  	array('', $ReadingHour.'.30', $Slot7Average*1.6),
  	array('', $ReadingHour.'.35', $Slot8Average*1.6),
  	array('', $ReadingHour.'.40', $Slot9Average*1.6),
  	array('', $ReadingHour.'.45', $Slot10Average*1.6),
  	array('', $ReadingHour.'.50', $Slot11Average*1.6),
  	array('', $ReadingHour.'.55', $Slot12Average*1.6),
...
# Main plot title:
$plot->SetTitle('Average Wind Speed(Km/h) Readings every hour:'.date("h:i:sa"));
