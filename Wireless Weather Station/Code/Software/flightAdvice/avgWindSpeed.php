...
$sql = "SELECT * from averagesensordata where stationid='1' and sensorid='WS' order by id  desc limit 1;;";
...
# Main plot title:
$plot->SetTitle('Average Wind Speed in (Km/h) every hour:'.date("h:i:sa"));
