...
$sql = "SELECT * from sensordata where stationid = '1' and sensorid='T' order by id desc limit 300";
...
if ($result->num_rows > 0) {
     ...
     while($row = $result->fetch_assoc()) {
		 ...
		 $tempArr = array('', $hour.'.'.$fraction, ($SensorReading-32)/1.8);
...
# Main plot title:
$plot->SetTitle('Individual Temperature Readings...:'.date("h:i:sa"));
